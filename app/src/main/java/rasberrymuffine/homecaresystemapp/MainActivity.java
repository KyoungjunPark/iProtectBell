...
/*
            ...
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                ConnectServer.getInstance().setAsncTask(new AsyncTask<String, Void, Boolean>() {
                    ...
                    protected Boolean doInBackground(String... params) {
                        ...
                        URL obj = null;
                        try {
                            obj = new URL("http://165.194.9.60:5000/door");
    ...
    private void sendLogToServer(final String type, final String information, final String importance) {
        ConnectServer.getInstance().setAsncTask(new AsyncTask<String, Void, Boolean>() {
            ...
            protected Boolean doInBackground(String... params) {
                ...
                URL obj = null;
                try {
                    obj = new URL("http://165.194.9.60:5000/send_log");
                    HttpURLConnection con = (HttpURLConnection) obj.openConnection();
    ...
    private void sendVideoInfoToServer(final int myWidth, final int myHeight) {
        ...
        ConnectServer.getInstance().setAsncTask(new AsyncTask<String, Void, Boolean>() {
            ...
            protected Boolean doInBackground(String... params) {
                ...
                URL obj = null;
                try {
                    obj = new URL("http://165.194.9.60:5000/setting_video");
                    HttpURLConnection con = (HttpURLConnection) obj.openConnection();
    ...
    private void loadVideo() {
        ...
        videoView.loadUrl("http://165.194.9.60:8080/stream");
                ...
                if(action.equals(QuickstartPreferences.REGISTRATION_READY)){
                    ...
                    ConnectServer.getInstance().setAsncTask(new AsyncTask<String, Void, Boolean>() {
                        ...
                        protected Boolean doInBackground(String... params) {
                            ...
                            URL obj = null;
                            try {
                                obj = new URL("http://165.194.9.60:5000/gcm");
                                HttpURLConnection con = (HttpURLConnection) obj.openConnection();
